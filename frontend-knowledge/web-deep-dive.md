...
### ⑥ TLS 1.2 vs TLS 1.3 握手过程

#### TLS 1.2 完整握手（2 次网络往返）
...
#### 实战例子：你访问 bank.com 时 TLS 到底做了什么
...
### ② 被墙和污染 — Cloudflare 和 Google 在中国的问题
...
### ④ 本地网络功能 — ISP 的 DNS 能做 Cloudflare 做不到的事
...
### 追问：电脑连 VPN 不也要先经过 GFW 吗？GFW 为什么不直接拦掉？
...
### 免费 HTTPS：Let's Encrypt + Certbot
